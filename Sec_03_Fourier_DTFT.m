...
fourTime = (0:pnts-1)/pnts; % normalised time vector for the csw
...
for triali=1:ntrials
    data(triali,:) = sin(2*pi*20*time + 1*pi*rand);
end
...
%% (in)correct DC reconstruction without careful normalization
