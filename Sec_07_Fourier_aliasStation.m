...
hold on
stem(hz,2*abs(signal1X(1:length(hz))),'bs-','linew',1,'markerface','k')
...
subplot(212)
xX = fft(x)/n;
stem(hz,2*abs(xX(1:length(hz))),'ks-','linew',2)
...
set(gca,'xlim',[0 freq*2],'ylim',[0 0.6])
xlabel('Frequency (Hz)'), ylabel('Amplitude')
